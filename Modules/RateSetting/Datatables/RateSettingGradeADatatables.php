...
class RateSettingGradeADatatables extends Datatables
{
     ...
     * @var String
     */
    protected $title = 'Rate Setting Grade A';
    ...
    {
        return route('ladmin.ratesetting.grade-a.index', ['datatables']);
    }
    ...
    {
        $this->query = RateSetting::query()->where('grading_type', 'A');
    }
