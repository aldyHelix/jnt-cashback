...
class UploadFileServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        $this->mergeConfigFrom(
            __DIR__ . '/../config/module.php', 'uploadfile'
        );
    }
    ...
    {
        $this->loadViewComponentsAs('uploadfile', [
            // Alert::class,
        ]);
    }
    ...
    {
        $this->loadViewsFrom(__DIR__ . '/../Resources/views', 'uploadfile');
    }
    ...
    {
        $this->loadTranslationsFrom(__DIR__ . '/../lang', 'uploadfile');
    }
}
