<x-ladmin-auth-layout>
    <x-slot name="title">Grading Summary Grading {{ $grading }}</x-slot>
                ...
                @elseif($grading == 2)
                    ...
                    @endphp
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                @foreach ($data_grading_2 as $item)
                                    <tr>
                                        <td style="text-align: left">{{$item->kode_cp}}</td>
                                        <td style="text-align: left">{{$item->nama_cp}}</td>
                                        <td>Rp {{ rupiah_format($item->total_cashback_reguler)}}</td>
                                ...
                                <tr class="font-weight-bold border">
                                    <td style="text-align: left" colspan="2">Total</td>
                                    <td>Rp {{ rupiah_format($data_grading_2->sum('total_cashback_reguler')) }}</td>
                                    <td>Rp {{ rupiah_format($data_grading_2->sum('total_cashback_marketplace_non_cod')) }}</td>
                                    <td>Rp {{ rupiah_format($data_grading_2->sum('total_cashback')) }}</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
