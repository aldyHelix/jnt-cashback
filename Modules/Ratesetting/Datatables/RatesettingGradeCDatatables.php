...
class RatesettingGradeCDatatables extends Datatables
{
    /**
     * Page title
     *
     * @var String
     */
    protected $title = 'Rate Setting Grade C';
    ...
    {
        return route('ladmin.ratesetting.grade-c.index', ['datatables']);
    }
    ...
    {
        $this->query = Ratesetting::query()->where('grading_type', 'C');
    }
