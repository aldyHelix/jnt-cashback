...
class GlobalSettingServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        $this->mergeConfigFrom(
            __DIR__ . '/../config/module.php', 'globalsetting'
        );
    }
    ...
    {
        $this->loadViewComponentsAs('globalsetting', [
            // Alert::class,
        ]);
    }
    ...
    {
        $this->loadViewsFrom(__DIR__ . '/../Resources/views', 'globalsetting');
    }
    ...
    {
        $this->loadTranslationsFrom(__DIR__ . '/../lang', 'globalsetting');
    }
}
